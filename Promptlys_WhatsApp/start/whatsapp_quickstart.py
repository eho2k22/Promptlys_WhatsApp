...
data = get_text_message_input(
    recipient=RECIPIENT_WAID, text=" Greeting from Promptlys on WhatsApp !."
)
...
data = get_text_message_input(
    recipient=RECIPIENT_WAID, text="Hello, this is a CUSTOM MESSAGE SENT from PROMPTLYS on WHATSAPP!."
)
